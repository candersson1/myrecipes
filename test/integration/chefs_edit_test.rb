...
class ChefsEditTest < ActionDispatch::IntegrationTest
  ...
  test "accept edit attempt by admin user" do
    ...
    get edit_chef_path(@chef)
    assert_template 'chefs/edit'
    patch chef_path(@chef), params: {chef: { chefname: "Christopher1", email: "xsweedeeee@gmail.com" } }
    assert_redirected_to @chef
    assert_not flash.empty?
    @chef.reload
    assert_match "Christopher1", @chef.chefname
    assert_match "xsweedeeee@gmail.com", @chef.email
  end
 ...
 sign_in_as(@chef2, "password")
    ...
    assert_not flash.empty?
    assert_match "Chris", @chef.chefname
    assert_match "candersson@klarsolutions.com", @chef.email
  end
